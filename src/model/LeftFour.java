...
//assume that box1 is the one on the pivot's closest (top left in the above diagram),
//box2 on the on the longer side but closer (bottom left in the above),
//and box3 on the longer side but further (bottom right in the above)
package model;

import java.util.ArrayList;

public class LeftFour extends Block { 
	
	//constructor
	public LeftFour(double pivotX1, double pivotY1, double boxSize) {
		super(pivotX1, pivotY1, boxSize);
		this.side = Facing.LEFT; //starts facing left by default (the orientation depicted in the diagram above)
		this.type = BlockType.LEFT_FOUR;
	}

	
	//the following three methods return the x and y values of the respective elements to simulate a rotation using the moveAdjacent and moveFurther methods
